    ...
    <div style="box-shadow: 1px 1px 8px #bdbdbd" class="container mx-auto p-8">
        ...
        <form action="{{ route('contacts.store') }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 gap-6">
              ...
              <button style="box-shadow: 1px 1px 8px #4338CA" type="submit" class="mt-4 bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Create</button>
